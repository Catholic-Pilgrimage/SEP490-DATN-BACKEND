...
exports.createLocalGuide = async (req, res) => {
    try {
        ...
        const result = await LocalGuideService.createLocalGuide(req.user.id, req.body);
...
exports.getLocalGuides = async (req, res) => {
    try {
        ...
        const result = await LocalGuideService.getLocalGuides(req.user.id, {
 ...
 * PATCH /api/manager/local-guides/:id/status
 */
exports.updateLocalGuideStatus = async (req, res) => {
    try {
        ...
        const result = await LocalGuideService.updateLocalGuideStatus(req.user.id, req.params.id, status);
